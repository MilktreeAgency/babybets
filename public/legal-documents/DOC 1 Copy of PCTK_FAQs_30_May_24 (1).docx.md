...
First, ensure you have opened an account on our website. Then choose the competition you wish to enter.
...
The prizes are described fully on the website. You can find out more details by clicking here [www.babybets.co.uk](http://www.babybets.co.uk)  
...
Full details of how we use your data are included in our Privacy Policy which you can read here [www.babybets.co.uk/privacy](http://www.babybets.co.uk/privacy) 
...
Whilst this may be disappointing, you have to remember that this is a competition and we have deliberately made the question tough to comply with the law. (See more on this below \[INSERT LINK\]) 
...
If you haven’t received an email from us confirming your entry and whether you got the question right or wrong, please check your spam folder. If it is not in there, please email us at [hello@babybets.co.uk](mailto:hello@babybets.co.uk) 
...
If you have any questions that have not been answered here, please email us at [hello@babybets.co.uk](mailto:hello@babybets.co.uk) and we will happily answer them for you.

**Can I collect my prize if I win?**

Collection can be made at our trading address, this must be arranged in advance via email [hello@babybets.co.uk](mailto:hello@babybets.co.uk)  You are then free to collect or we can deliver.

**Can I exchange my prize?**

No prizes are set for each draw and are final. You may have the option of a cash alternative on some prize draws as stated.

**How is a winner chosen?**

All entries will receive a ticket number inside their account to each draw entered.  
We use a random number generator to select winners, this will take place live on social media. 

**When will the competition close?**

A timer will be set for each draw and clearly displayed on the website for each competition. Once the time has run out or all tickets are sold the draw time and day will be set. This will be announced on Social media and the website.

**How do I pay?**

We accept all major cards as standard as well as Apple pay and Google pay. All payments are secure. A free entry method is also available.

**Do I need to be over 18 to play?**

Yes, all players must be over the age of 18 to enter any of our competitions. You will need to verify that you are over 18 at checkout by ticking a box confirming that you are 18+ and you accept our terms and conditions (you cannot complete purchase without this confirmation). If any winner is found to be under the age of 18, then the competition will be redrawn.